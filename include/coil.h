...
class coil{
    public:
        ...
        void set_rotation(AngleAxisd new_aa);
        ...
        void compose_rotation(AngleAxisd next_rotation);
        // get rotation angle and axis of coil
        AngleAxisd get_rotation();
        AngleAxisd get_rotation_inv();
        // get rotation axis/angle of coil
        Vector3d get_rotation_axis();
    ...
    private:				
        ...
        AngleAxisd coil_rotation; 
        // inverse rotation matrix for coil
        AngleAxisd coil_rotation_inv; 
        // coil origin
        Vector3d origin; 
        // number of subcoils
