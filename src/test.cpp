...
int main(){
    ...
    int axis = -1;	
    helix magneto(helix_coils,axis);
    magneto.contract();

    Vector3d helix_field,heat_field;
...
// Fixed magnet test
    ...
    helix_field = magneto.B(position);
    heat_field = HeatB(position);
...
//// Test changing the position of the magnet
